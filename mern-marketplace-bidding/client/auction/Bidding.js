        ...
        <div>
            ...
            <div className={classes.bidHistory}>
                ...
                <Grid container spacing={4}>
                    <Grid item xs={3} sm={3}>
                        <Typography variant="subtitle1" color="#edc4b3">Bid Amount</Typography>
                    </Grid>
                    <Grid item xs={5} sm={5}>
                        <Typography variant="subtitle1" color="#edc4b3">Bid Time</Typography>
                    </Grid>
                    <Grid item xs={4} sm={4}>
                        <Typography variant="subtitle1" color="#edc4b3">Bidder</Typography>
                    </Grid>
                </Grid>    
